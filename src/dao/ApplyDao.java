...
public class ApplyDao {
	public String Apply(ApplyBean applybean)
	 ...
	 String query ="insert into Reg(title,firstname,middlename,lastname,ftitle,ffirstname,fmiddlename,flastname,gender,hno,street,state,country,city,email,qualification,specialization,languages_know) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	ps.setString(11,street);
	 ...
	 ps.setString(17,specialization);
	 ps.setString(18,languages_know);
